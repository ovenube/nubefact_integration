                ...
                if doc.sales_invoice_advance is not None:
                    ...
                    for item in doc.items:
                        ...
                        content['items'].append({
                            ...
                            "precio_unitario": str(round(item.unit_value, 2)) if (item.unit_value > 0) else (str(round(item.rate, 2)) if igv_inc == 1 else str(round(item.net_rate, 2) * 1.18)),
                            ...
                            "tipo_de_igv": "6" if (item.unit_value > 0) else "1",
